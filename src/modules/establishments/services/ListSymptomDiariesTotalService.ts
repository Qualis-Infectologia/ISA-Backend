...
@injectable()
class ListSymptomDiariesTotalService {
  constructor(
  ...
  public async execute(establishment: Establishment): Promise<Return[]> {
    ...
    const symptoms = [
      {
        column: 'smellLoss',
        name: 'Total Perda do olfato diários',
        shortName: 'Perda do olfato (cheiro)',
        type: {},
      },
      {
        column: 'tasteLoss',
        name: 'Total Perda do paladar diários',
      ...
      {
        column: 'fatigue',
        name: 'Total Cansaço diários',
        shortName: 'Cansaço ou dor no corpo',
        type: {},
      },
      {
        column: 'fever',
        name: 'Total Febre diários',
        shortName: 'Febre',
        type: {},
      },
      {
        column: 'cough',
        name: 'Total Tosse persistente diários',
        shortName: 'Tosse persistente',
        type: {},
      },
      {
        column: 'diarrhea',
        name: 'Total Diarréia diários',
        shortName: 'Diarréia ou dor de barriga',
        type: {},
      },
      {
        column: 'soreThroat',
        name: 'Total Rouquidão diários',
      ...
      {
        column: 'headache',
        name: 'Total Dor de cabeça diários',
...
export default ListSymptomDiariesTotalService;
