...
class ListSymptomaticService {
  ...
  public async execute(establishment: Establishment): Promise<number> {
    ...
    const type = await this.statisticTypesRepository.findByName('Sintomáticos');
...
export default ListSymptomaticService;
